...
from hw1_part3 import recover_kernel
...
def main():
    ...
    Command line usage: python main.py -t | --test <filter or hybrid> -i | --image <image path(s) separated by comma (no spaces)>
    ...
    e.g.
    python main.py -t filter -i ../data/dog.bmp
    python main.py -t hybrid -i ../data/cat.bmp,../data/dog.bmp
    ...
    # if testing hybrid (part 2)
        ...
        if not os.path.exists(input_image):
            print('The file path you specified for image does not exist')
        else:
            print('running kernel recovery test on image ' + input_image)
            recover_kernel(input_image, k=3)
