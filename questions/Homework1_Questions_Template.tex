...
% TAs-only: compile once with export enabled to generate csci1430_expectedpages.tex
%\EnableExpectedPagesExport{csci1430_expectedpages.tex}
\LoadExpectedPages{csci1430_expectedpages.tex}
